...
auto evaluate_nodal_corrections(double omega, double p,
  ...
  for (size_t ix = 0; ix < constituents.size(); ++ix) {
    ...
    switch (constituent) {
      ...
      case kMSm:
        term1 =
            (-0.0534 * sin2p) - (0.0219 * std::sin((radians((2 * p) - omega))));
      ...
      case kL2:
        term1 = (-0.250 * sin2p) -
                (0.110 * std::sin((radians((2 * p) - omega)))) - (0.037 * sinn);
    ...
    if (term1 == 0.0) {
      ...
      switch (constituent) {
        ...
        case k2MK6:
          ...
          correction.u =
              (2.0 * nodal_corrections[0].u) + nodal_corrections[1].u;
          break;
        case kMO3:
...
auto evaluate_nodal_corrections(double perihelion, double omega, double perigee,
  ...
  for (size_t ix = 0; ix < constituents.size(); ++ix) {
    ...
    switch (constituent) {
      case kMm:
        term1 = (-0.0137 * std::sin(-two_h + two_p - o)) +
                (0.1912 * std::sin(-two_h + two_p)) -
                (0.0125 * std::sin(-two_h + two_p + o)) -
                (0.0657 * std::sin(-o)) - (0.0653 * std::sin(o)) -
                (0.0534 * std::sin(two_p)) - (0.0219 * std::sin(two_p + o)) -
                (0.0139 * std::sin(two_h));
        term2 = 1.0 + (0.0137 * std::cos(two_h - two_p - o)) +
                (0.1912 * std::cos(-two_h + two_p)) -
                (0.0125 * std::cos(-two_h + two_p + o)) -
                (0.1309 * std::cos(o)) - (0.0534 * std::cos(two_p)) -
                (0.0219 * std::cos(two_p + o)) - (0.0139 * std::cos(two_h));
        break;
      case kMf: {
        auto two_o = 2.0 * o;
        term1 = (0.0875 * std::sin(-two_h)) + (0.0432 * std::sin(-two_p)) +
                (0.4145 * std::sin(o)) + (0.0387 * std::sin(two_o));
        term2 = 1.0 + (0.0875 * std::cos(two_h)) + (0.0432 * std::cos(two_p)) +
                (0.4145 * std::cos(o)) + (0.0387 * std::cos(two_o));
      } break;
      case kMtm:
        term1 =
            (0.0721 * std::sin(-two_h)) + (0.1897 * std::sin(-two_h + two_p)) +
            (0.0784 * std::sin(-two_h + two_p + o)) + (0.4146 * std::sin(o));
        term2 = 1.0 + (0.0721 * std::cos(two_h)) +
                (0.1897 * std::cos(-two_h + two_p)) +
                (0.0784 * std::cos(-two_h + two_p + o)) +
                (0.4146 * std::cos(o));
        break;
      case kMqm:
        term1 = (1.207 * std::sin(-two_h + two_p)) +
                (0.497 * std::sin(-two_h + two_p + o)) + (0.414 * std::sin(o));
        term2 = 1.0 + (1.207 * std::cos(-two_h + two_p)) +
                (0.497 * std::cos(-two_h + two_p + o)) + (0.414 * std::cos(o));
        break;
      case k2Q1:
        term1 = (0.1886 * std::sin(-o)) +
                (0.2274 * std::sin(two_h - two_p - o)) +
                (1.2086 * std::sin(two_h - two_p));
        term2 = 1.0 + (0.1886 * std::cos(o)) +
                (0.2274 * std::cos(two_h - two_p - o)) +
                (1.2086 * std::cos(two_h - two_p));
        break;
      case kSigma1:
        term1 = (0.1561 * std::sin(-two_h + two_p - o)) -
                (0.1882 * std::sin(o)) + (0.7979 * std::sin(-two_h + two_p)) +
                (0.0815 * std::sin(h - pp));
        term2 = 1.0 + (0.1561 * std::cos(-two_h + two_p - o)) +
                (0.1882 * std::cos(o)) + (0.8569 * std::cos(-two_h + two_p)) +
                (0.0538 * std::cos(h - pp));
        break;
      case kQ1:
        term1 = (0.1886 * std::sin(-o)) +
                (0.0359 * std::sin(two_h - two_p - o)) +
                (0.1901 * std::sin(two_h - two_p));
        term2 = 1.0 + (0.1886 * std::cos(o)) +
                (0.0359 * std::cos(two_h - two_p - o)) +
                (0.1901 * std::cos(two_h - two_p));
        break;
      case kO1: {
        auto two_o = 2.0 * o;
        term1 = (-0.0058 * std::sin(-two_o)) + (0.1886 * std::sin(-o)) -
                (0.0065 * std::sin(two_p)) - (0.0131 * std::sin(two_h));
        term2 = 1.0 - (0.0058 * std::cos(two_o)) + (0.1886 * std::cos(o)) -
                (0.0065 * std::cos(two_p)) - (0.0131 * std::cos(two_h));
        break;
      }
      case kM1:  // Note: central line is 155.655
        term1 = (0.0941 * std::sin(-two_h)) + (0.0664 * std::sin(-two_p - o)) +
                (0.3594 * std::sin(-two_p)) + (0.2008 * std::sin(o)) +
                (0.1910 * std::sin(two_h - two_p)) +
                (0.0422 * std::sin(two_h - two_p + o));
        term2 = 1.0 + (0.0941 * std::cos(two_h)) +
                (0.0664 * std::cos(two_p + o)) + (0.3594 * std::cos(two_p)) +
                (0.2008 * std::cos(o)) + (0.1910 * std::cos(two_h - two_p)) +
                (0.0422 * std::cos(two_h - two_p + o));
        break;
      case kK1: {
        auto two_o = 2.0 * o;
        auto three_h = 3.0 * h;
        term1 = (-0.0184 * std::sin(-three_h + pp)) +
                (0.0036 * std::sin(-two_h - o)) + (0.3166 * std::sin(two_h)) -
                (0.0026 * std::sin(h + pp)) + (0.0075 * std::sin(-h + pp)) +
                (0.1558 * std::sin(o)) - (0.0030 * std::sin(two_o)) +
                (0.0049 * std::sin(h - pp)) + (0.0128 * std::sin(two_h));
        term2 = 1.0 - (0.0184 * std::cos(-three_h + pp)) +
                (0.0036 * std::cos(two_h + o)) - (0.3166 * std::cos(two_h)) +
                (0.0026 * std::cos(h + pp)) + (0.0075 * std::cos(h - pp)) +
                (0.1164 * std::cos(o)) - (0.0030 * std::cos(two_o)) +
                (0.0049 * std::cos(h - pp)) + (0.0128 * std::cos(two_h));
        break;
      }
      case kJ1:
        term1 = (0.1922 * std::sin(-two_h + two_p)) +
                (0.0378 * std::sin(-two_h + two_p + o)) +
                (0.2268 * std::sin(o)) - (0.0155 * std::sin(two_p));
        term2 = 1.0 + (0.1922 * std::cos(-two_h + two_p)) +
                (0.0378 * std::cos(-two_h + two_p + o)) +
                (0.1701 * std::cos(o)) - (0.0155 * std::cos(two_p));
        break;
      case kOO1: {
        auto two_o = 2.0 * o;
        term1 = (0.3029 * std::sin(-two_h)) + (0.0593 * std::sin(-two_h + o)) +
                (0.1497 * std::sin(-two_p)) + (0.6404 * std::sin(o)) +
                (0.1337 * std::sin(two_o));
        term2 = 1.0 + (0.3029 * std::cos(-two_h)) +
                (0.0593 * std::cos(-two_h + o)) + (0.1497 * std::cos(-two_p)) +
                (0.6404 * std::cos(o)) + (0.1337 * std::cos(two_o));
        break;
      }
      case kEps2:
        term1 = (0.385 * std::sin(-two_h + two_p));
        term2 = 1.0 + (0.385 * std::cos(-two_h + two_p));
        break;
      case k2N2:  // Better is mu2 unless 2MS2 active
      {
        ...
        auto four_h = 4.0 * h;
        auto four_p = 4.0 * p;
        term1 = (0.0374 * std::sin(o)) + (1.2064 * std::sin(two_h - two_p)) -
                (0.0139 * std::sin(-h + pp)) -
                (0.0170 * std::sin(h - two_p + pp)) -
                (0.0104 * std::sin(h - p)) + (0.0156 * std::sin(h - pp)) -
                (0.0448 * std::sin(two_h - two_p - o)) +
                (0.0808 * std::sin(three_h - two_p - 4.939)) +
                (0.0369 * std::sin(four_h - four_p));
        term2 =
            1.0 - (0.0374 * std::cos(o)) + (1.2064 * std::cos(two_h - two_p)) -
            (0.0139 * std::cos(-h + pp)) - (0.0170 * std::cos(h - two_p + pp)) -
            (0.0104 * std::cos(h - p)) + (0.0156 * std::cos(h - pp)) -
            (0.0448 * std::cos(two_h - two_p - o)) +
            (0.0808 * std::cos(three_h - two_p - 4.939)) +
            (0.0369 * std::cos(four_h - four_p));
        break;
      }
      case kMu2:
        term1 = -(0.0115 * std::sin((-3.0 * h) + two_p + pp)) -
                (0.0310 * std::sin(-two_h + two_p - o)) +
                (0.8289 * std::sin(-two_h + two_p)) -
                (0.0140 * std::sin(-h + pp)) - (0.0086 * std::sin(-h + p)) +
                (0.0130 * std::sin(-h + two_p - pp)) + (0.0371 * std::sin(o)) +
                (0.0670 * std::sin(h - pp)) +
                (0.0306 * std::sin(two_h - two_p));
        term2 = 1.0 - (0.0115 * std::cos((-3.0 * h) + two_p + pp)) -
                (0.0310 * std::cos(-two_h + two_p - o)) +
                (0.8289 * std::cos(-two_h + two_p)) -
                (0.0140 * std::cos(-h + pp)) - (0.0086 * std::cos(-h + p)) +
                (0.0130 * std::cos(-h + two_p - pp)) - (0.0371 * std::cos(o)) +
                (0.0670 * std::cos(h - pp)) +
                (0.0306 * std::cos(two_h - two_p));
        break;
      case kN2:
        term1 = -(0.0084 * std::sin(-h + pp)) - (0.0373 * std::sin(-o)) +
                (0.0093 * std::sin(h - pp)) +
                (0.1899 * std::sin(two_h - two_p)) -
                (0.0071 * std::sin(two_h - two_p - o));
        term2 = 1.0 - (0.0084 * std::cos(-h + pp)) - (0.0373 * std::cos(o)) +
                (0.0093 * std::cos(h - pp)) +
                (0.1899 * std::cos(two_h - two_p)) -
                (0.0071 * std::cos(two_h - two_p - o));
        break;
      case kM2:
        term1 = -(0.0030 * std::sin(-two_h + two_p)) - (0.0373 * std::sin(-o)) +
                (0.0065 * std::sin(h - pp)) + (0.0011 * std::sin(two_h));
        term2 = 1.0 - (0.0030 * std::cos(-two_h + two_p)) -
                (0.0373 * std::cos(o)) - (0.0004 * std::cos(h - pp)) +
                (0.0011 * std::cos(two_h));
        break;
      case kL2:
        term1 = (0.2609 * std::sin(-two_h + two_p)) - (0.0370 * std::sin(-o)) -
                (0.2503 * std::sin(two_p)) - (0.1103 * std::sin(two_p + o)) -
                (0.0491 * std::sin(two_h)) - (0.0230 * std::sin(two_h + o));
        term2 = 1.0 + (0.2609 * std::cos(-two_h + two_p)) -
                (0.0370 * std::cos(o)) - (0.2503 * std::cos(two_p)) -
                (0.1103 * std::cos(two_p + o)) - (0.0491 * std::cos(two_h)) -
                (0.0230 * std::cos(two_h + o));
        break;
      case kS2:
        term1 = (0.0585 * std::sin(-h + pp)) - (0.0084 * std::sin(h - pp)) +
                (0.2720 * std::sin(two_h)) + (0.0811 * std::sin(two_h + o)) +
                (0.0088 * std::sin(two_h + (2.0 * o)));
        term2 = 1.0 + (0.0585 * std::cos(-h + pp)) -
                (0.0084 * std::cos(h - pp)) + (0.2720 * std::cos(two_h)) +
                (0.0811 * std::cos(two_h + o)) +
                (0.0088 * std::cos(two_h + (2.0 * o)));
        break;
      default:
        term1 = 0.0;
        term2 = 0.0;
