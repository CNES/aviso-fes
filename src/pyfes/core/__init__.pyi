...
from ..type_hints import VectorComplex64,VectorComplex128, VectorDateTime64, VectorFloat64, VectorInt8
...
class AbstractTidalModelComplex128:
    ...
    def accelerator(self, formulae: Formulae = ..., time_tolerance: typing.SupportsFloat = ...) -> Accelerator: ...
    def add_constituent(self, name: str, wave: VectorComplex128) -> None: ...
    def clear(self) -> None: ...
    def identifiers(self) -> list[str]: ...
    def interpolate(self, lon: VectorFloat64, lat: VectorFloat64, num_threads: typing.SupportsInt = ...) -> tuple[dict[str, VectorComplex128], VectorInt8]: ...
...
class AbstractTidalModelComplex64:
    ...
    def clear(self) -> None: ...
    def identifiers(self) -> list[str]: ...
    def interpolate(self, lon: VectorFloat64, lat: VectorFloat64, num_threads: typing.SupportsInt = ...) -> tuple[dict[str, VectorComplex64], VectorInt8]: ...
    def __bool__(self) -> bool: ...
    def __len__(self) -> int: ...
...
class TidalType:
    __members__: ClassVar[dict] = ...  # read-only
    LONG_PERIOD: ClassVar[TidalType] = ...
    SHORT_PERIOD: ClassVar[TidalType] = ...
    __entries: ClassVar[dict] = ...
    def __init__(self, value: typing.SupportsInt) -> None: ...
    def __eq__(self, other: object) -> bool: ...
    def __hash__(self) -> int: ...
