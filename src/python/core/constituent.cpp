...
void init_constituent(py::module& m) {
  py::enum_<fes::Constituent>(m, "Constituent")
      ...
      .value("kMSK2", fes::kMSK2, ":math:`MSK_{2}`")
      .value("kSKM2", fes::kSKM2, ":math:`SKM_{2}`")
      .value("kOQ2", fes::kOQ2, ":math:`OQ_{2}`")
      .value("k3MS4", fes::k3MS4, ":math:`3MS_{4}`")
      .value("kMNu4", fes::kMNu4, ":math:`MNu_{4}`")
      .value("k2MSN4", fes::k2MSN4, ":math:`2MSN_{4}`")
      .value("k2NS2", fes::k2NS2, ":math:`2NS_{2}`")
      .value("kMNuS2", fes::kMNuS2, ":math:`MNuS_{2}`")
      .value("k2MK2", fes::k2MK2, ":math:`2MK_{2}`")
      .value("kNKM2", fes::kNKM2, ":math:`NKM_{2}`")
      .value("kML4", fes::kML4, ":math:`ML_{4}`")
      .value("kSO1", fes::kSO1, ":math:`SO_{1}`")
      .value("kSO3", fes::kSO3, ":math:`SO_{3}`")
      .value("kNK4", fes::kNK4, ":math:`NK_{4}`")
      .value("kMNK6", fes::kMNK6, ":math:`MNK_{6}`")
      .value("k2NM6", fes::k2NM6, ":math:`2NM_{6}`")
      .value("k3MS8", fes::k3MS8, ":math:`3MS_{8}`")
      .value("kSK3", fes::kSK3, ":math:`SK_{3}`")
      .value("k2MNS4", fes::k2MNS4, ":math:`2MNS_{4}`")
      .value("k2SMu2", fes::k2SMu2, ":math:`2SMu_{2}`")
      .value("k2MP5", fes::k2MP5, ":math:`2MP_{5}`")
      .export_values();
